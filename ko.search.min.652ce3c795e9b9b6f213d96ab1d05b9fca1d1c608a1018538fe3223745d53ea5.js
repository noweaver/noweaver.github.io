...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ko.search-data.min.5a2cac764995254b17d08729453f5e6afdd31a51c4166ba0115ad715fad65be3.js',function(){input.required=false;search();});}
