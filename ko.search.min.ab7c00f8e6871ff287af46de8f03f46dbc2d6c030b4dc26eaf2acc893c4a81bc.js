...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ko.search-data.min.e193cd3e2ae1f336f2237cb8b42449c404d3cd1871654fafbc27df258c290c8e.js',function(){input.required=false;search();});}
