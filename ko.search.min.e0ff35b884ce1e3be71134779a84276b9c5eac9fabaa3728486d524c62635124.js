...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ko.search-data.min.a5e1743371406d7be9d8eb8925a59aa5652d3244f738905a02ff9176bdb8c1e8.js',function(){input.required=false;search();});}
