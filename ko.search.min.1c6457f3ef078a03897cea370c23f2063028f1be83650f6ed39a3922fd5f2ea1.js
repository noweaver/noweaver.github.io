...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ko.search-data.min.d8f7a01c0e64de502d3ea16deb6bb9daed757fe3fb64c8d53a408d2a9350c71e.js',function(){input.required=false;search();});}
