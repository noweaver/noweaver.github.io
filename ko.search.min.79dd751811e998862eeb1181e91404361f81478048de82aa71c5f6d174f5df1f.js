...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ko.search-data.min.617480cdba6c4203f58ffb626843cd86f581faed31301e37544ca0153bd05b7d.js',function(){input.required=false;search();});}
