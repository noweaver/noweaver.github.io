...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ko.search-data.min.472d977357189456b14ae09f9846900171963a47d7fe886e85bc74c4e160eabc.js',function(){input.required=false;search();});}
