...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ko.search-data.min.8d7b240fc4680b00a19fce7c3361379d34d1ae6fd546ede8139142938a1fcffe.js',function(){input.required=false;search();});}
