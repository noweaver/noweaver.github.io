...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ko.search-data.min.2949f13f26ddd7849a07d12b6bfa8643cc0a39f399bc382b285e5eeedba71ae1.js',function(){input.required=false;search();});}
